...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[92vw] max-w-[400px] md:w-auto md:max-w-fit md:overflow-visible overflow-x-auto no-scrollbar whitespace-nowrap bg-white/40 backdrop-blur-md sm:backdrop-blur-2xl border border-white/60 shadow-lg shadow-black/5 px-1.5 py-1 md:px-3 md:py-1.5 gap-1 md:gap-2 rounded-full transform-gpu will-change-transform"
