...
const projects = [
  {
    ...
    description:
      "A real-time data visualization platform built for enterprise teams. Features interactive charts, predictive modeling, and automated reporting.",
    tags: ["React", "D3.js", "Python", "PostgreSQL"],
  },
  {
    title: "E-Commerce Platform",
    description:
      "Full-stack marketplace with headless CMS, payment integration, and a custom recommendation engine powered by collaborative filtering.",
    tags: ["Next.js", "Stripe", "Node.js", "MongoDB"],
  },
  {
    title: "ML Pipeline Tool",
    description:
      "Visual drag-and-drop interface for building machine learning pipelines. Supports data preprocessing, model training, and deployment workflows.",
    tags: ["TypeScript", "TensorFlow", "FastAPI", "Docker"],
  },
  {
    title: "Portfolio CMS",
    description:
      "A minimalist content management system for creatives. Markdown-first with real-time preview and one-click deployment.",
